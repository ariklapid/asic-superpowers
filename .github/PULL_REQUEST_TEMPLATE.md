...
ASIC Superpowers status as of 2026-05-23:
- This repo is a standalone ASIC methodology plugin derived from Superpowers.
- Deterministic validation passes with `npm run validate`.
- Industry-grade release claims require live RTL/DV/Physical Design/toolchain
  transcript evidence.
-->
