...
## ASIC Superpowers Status

This file is inherited upstream Superpowers testing documentation. For the
current ASIC plugin validation flow, use
...
- Keep inherited upstream integration tests available for core workflow
  regressions.
- Add ASIC-specific live transcript summaries under `evals/` after clean runs.
